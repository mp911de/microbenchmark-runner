 ...
 */
package jmh.mbr.junit.discovery;

import java.util.regex.Pattern;

import jmh.mbr.junit.MicrobenchmarkEngine;
import jmh.mbr.junit.PartiallyParametrizedBenchmark;
import jmh.mbr.junit.descriptor.BenchmarkClassDescriptor;
import jmh.mbr.junit.descriptor.BenchmarkMethodDescriptor;
import jmh.mbr.junit.descriptor.ParametrizedBenchmarkMethodDescriptor;
...
class DiscoverySelectorResolverTests {
	...
	void shouldResolveBenchmarkMethodByMethodSelector() {
		...
		EngineDiscoveryResults results = EngineTestKit.engine(new MicrobenchmarkEngine())
				.selectors(selectMethod(PartiallyParametrizedBenchmark.class, "bar",
						"jmh.mbr.junit.PartiallyParametrizedBenchmark$ParamState"))
				.discover();
	...
	void shouldResolveBenchmarkMethodByUniqueIdSelector() {
		...
		EngineDiscoveryResults results = EngineTestKit.engine(new MicrobenchmarkEngine()).selectors(selectUniqueId(
						"[engine:microbenchmark-engine]/[class:jmh.mbr.junit.PartiallyParametrizedBenchmark]/[method:bar(jmh.mbr.junit.PartiallyParametrizedBenchmark$ParamState)]/[fixture:%5Bfoo=b%5D]"))
				.discover();
